...
var ASM_CONSTS = {
  70672: () => { FS.syncfs(false, function(err){}); },  
 70707: () => { FS.mkdir('/data'); FS.mount(IDBFS, {}, '/data'); FS.syncfs(true, function(err) { ccall('afterFSReady', null, [], []); }); }
};

// Imports from the Wasm binary.
var _fflush = makeInvalidEarlyAccess('_fflush');
var _handleInput = Module['_handleInput'] = makeInvalidEarlyAccess('_handleInput');
var _afterFSReady = Module['_afterFSReady'] = makeInvalidEarlyAccess('_afterFSReady');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['afterFSReady'] != 'undefined', 'missing Wasm export: afterFSReady');
  ...
  _afterFSReady = Module['_afterFSReady'] = createExportWrapper('afterFSReady', 0);
